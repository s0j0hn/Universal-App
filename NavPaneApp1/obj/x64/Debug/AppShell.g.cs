#pragma checksum "C:\Users\jan\Documents\3net-universal-app\NavPaneApp1\AppShell.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "7A492335A0225605302F998186E3C385"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SupStore
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class AppShell_obj2_Bindings :
            ...
            IAppShell_Bindings
        {
            private global::SupStore.NavMenuItem dataRoot;
            ...
            {
                 global::SupStore.NavMenuItem data = args.NewValue as global::SupStore.NavMenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::SupStore.NavMenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::SupStore.NavMenuItem);
                ...
                this.Update_((global::SupStore.NavMenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::SupStore.NavMenuItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::SupStore.NavMenuItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 7:
                {
                    this.NavMenuList = (global::SupStore.Controls.NavMenuListView)(target);
                    #line 71 "..\..\..\AppShell.xaml"
                    ((global::SupStore.Controls.NavMenuListView)this.NavMenuList).ContainerContentChanging += this.NavMenuItemContainerContentChanging;
                    #line 74 "..\..\..\AppShell.xaml"
                    ((global::SupStore.Controls.NavMenuListView)this.NavMenuList).ItemInvoked += this.NavMenuList_ItemInvoked;
                    #line default
                }
                break;
            case 8:
            ...
            case 2:
                {
                    ...
                    bindings.SetDataRoot((global::SupStore.NavMenuItem) element2.DataContext);
